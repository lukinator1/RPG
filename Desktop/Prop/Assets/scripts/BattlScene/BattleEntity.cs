...
public class BattleEntity : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (tag == "PlayerCharacter") {
            ...
            battleentitysprites = BattleSceneGlobalData.battlesceneglobalinstance.players[battleentityposition].localPlayerCharacterData.battleentitysprites;
            HP = BattleSceneGlobalData.battlesceneglobalinstance.players[battleentityposition].localPlayerCharacterData.HP;
            mana = BattleSceneGlobalData.battlesceneglobalinstance.players[battleentityposition].localPlayerCharacterData.mana;
            lvl = BattleSceneGlobalData.battlesceneglobalinstance.players[battleentityposition].localPlayerCharacterData.lvl;
            //Debug.Log(battleentityposition.ToString());
            Debug.Log(BattleSceneGlobalData.battlesceneglobalinstance.players[battleentityposition].localPlayerCharacterData.name + " entered the battle, hp: " + HP + " mana: " + mana + " lvl: " + lvl);
